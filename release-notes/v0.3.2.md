...
The Hermes changes passed in locally signed development builds over USB on
...
follow-up build covered moving focus to another pane while MIC was held;
releasing MIC returned to the original Hermes pane and stopped recording
there. The GitHub-built v0.3.2 candidate has not yet completed its hardware
check.
