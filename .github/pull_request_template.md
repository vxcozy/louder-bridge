...
Describe the result a user will notice.
...
- [ ] If MIC behavior changed, I tested hold-to-talk and double-tap latching in an active Claude Code composer over USB-C and Bluetooth.
