...
test("requires the release tag to match the package version", () => {
  ...
  assert.match(
    mismatched.stderr,
    /Release tag v0\.1\.0 does not match package version 0\.1\.1/,
  );
});

test("requires the release tag commit to belong to the protected branch", () => {
  const outsideBranch = run("v0.1.1", { branchRef: "HEAD^" });
  ...
  const missingBranch = run("v0.1.1", { branchRef: null });
