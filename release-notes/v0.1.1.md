...
on the development build. On August 4, 2026, the downloaded v0.1.1 build also
passed its final Micro lighting check. All six Agent Keys showed their standby
and session colors, and the exterior lighting followed the active lifecycle
